<?php
/**
 * @version   $Id: ArrayHelper.php 53534 2012-06-06 18:21:34Z btowles $
...
/**
 * RokCommon_Utils_ArrayHelper is an array utility class for doing all sorts of odds and ends with arrays.
 *
 * @static
 */
class RokCommon_Utils_ArrayHelper
{
	/**
	...
	static function toInteger(&$array, $default = null)
	{
		if (is_array($array)) {
			...
			if ($default === null) {
				...
				RokCommon_Utils_ArrayHelper::toInteger($default, null);
				$array = $default;
			} else {
     ...
     * @param string      $class
     *
     * @internal param string $calss Name of the class to create
