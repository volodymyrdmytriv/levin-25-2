...
class dc_jqsocialmediatabs_widget extends WP_Widget {
    ...
    function update( $new_instance, $old_instance ) {
		...
		$instance['twitterWidget'] = strip_tags( stripslashes($new_instance['twitterWidget']) );
	...
	<p class="dcwp-row">
		<label for="<?php echo $this->get_field_id('twitterUrl'); ?>"><?php _e('Widget URL:') ?></label>
	...
	<p class="dcwp-row">
		<label for="<?php echo $this->get_field_id('twitterWidget'); ?>"><?php _e('Widget ID:') ?></label>
		<input type="text" id="<?php echo $this->get_field_id('twitterWidget'); ?>" name="<?php echo $this->get_field_name('twitterWidget'); ?>" value="<?php echo $twitterWidget; ?>" />
	</p>
	<p class="dcwp-row">
	...
	function dcsmt_inc_twitter($args, $instance){
		...
		$twitterWidget = $widget_options['twitterWidget'];

		$tab = '<div class="tab-twitter tab-inner"><a class="twitter-timeline"  href="https://twitter.com/'.$twitterUrl.'"  data-widget-id="'.$twitterWidget.'">Tweets by @'.$twitterUrl.'</a>
