...
$template_url = get_template_directory_uri(); 
  ...
  $evl_scheme_background_100 = evl_get_option('evl_scheme_background_100', '1');
...
$evolve_css_data .= '.menu-back {
 ...
 background: url('.$template_url.'/library/media/images/header-area.png) repeat,-webkit-gradient(radial, center center, 0, center center, 460, from('.$evl_scheme_widgets.'), to(#'.evolve_hexDarker($evl_scheme_color,40).'));  
 background: url('.$template_url.'/library/media/images/header-area.png) repeat,-webkit-radial-gradient(circle, '.$evl_scheme_widgets.', #'.evolve_hexDarker($evl_scheme_color,40).');  
 background: url('.$template_url.'/library/media/images/header-area.png) repeat,-moz-radial-gradient(circle, '.$evl_scheme_widgets.', #'.evolve_hexDarker($evl_scheme_color,40).');  
 background: url('.$template_url.'/library/media/images/header-area.png) repeat,-o-radial-gradient(circle, '.$evl_scheme_widgets.', #'.evolve_hexDarker($evl_scheme_color,40).');
 background: url('.$template_url.'/library/media/images/header-area.png) repeat,-ms-radial-gradient(circle, '.$evl_scheme_widgets.', #'.evolve_hexDarker($evl_scheme_color,40).');
}
...
if ($heading_font) {
 $evolve_css_data .= 'h1, h2, h3, h4, h5, h6 {font-family:' . $heading_font['face']. '; color:'.$heading_font['color'].';}';
 }   
