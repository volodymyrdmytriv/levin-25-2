...
function evolve_media() {
  ...
  wp_enqueue_style( 'bootstrapcsstheme', EVLJS . '/bootstrap/css/bootstrap-theme.css' );  
...
function evolve_copy() {
  ...
  if (!empty($options['evl_affiliate_id'])) { $ad_affiliate_id = '?ap_id='.$options['evl_affiliate_id']; } else { $ad_affiliate_id = ''; } 
	...
	$credits = '<p id="copyright"><span class="credits">© 2014 Levin Management. All rights reserved. Site by NetLZ</span></p>';
