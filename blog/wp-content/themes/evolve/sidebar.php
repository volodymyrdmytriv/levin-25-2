...
?>
        ...
        <div id="secondary" class="aside <?php if (($evl_layout == "1c")) {} if (($evl_layout == "3cm" || $evl_layout == "3cl" || $evl_layout == "3cr")) {echo 'col-xs-12 col-sm-6 col-md-3';} else {echo 'col-sm-6 col-md-4';} ?>">
