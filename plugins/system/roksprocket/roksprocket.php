...
class plgSystemRokSprocket extends JPlugin
{
	...
	const NEEDED_ROKCOMMON_VERSION = '3.1.6';
	/**
	 *
	 */
	...
	public function onAfterInitialise()
	{
		...
		define('ROKSPROCKET', '1.8.10');
		define('ROKSPROCKET_VERSION', '1.8.10');
	...
	protected function loadProviders(RokCommon_Service_Container &$container)
	{
		...
		if (version_compare($jversion->getShortVersion(), '3.1.0_beta3', '>=')){
			RokCommon_Composite::addPackagePath('roksprocket_providers', $container['roksprocket.providers.platforms_path'].'/joomla31',11);
		}
