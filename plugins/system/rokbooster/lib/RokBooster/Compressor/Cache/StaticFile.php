<?php
/**
 * @version   $Id: StaticFile.php 9566 2013-04-23 06:32:08Z btowles $
...
class RokBooster_Compressor_Cache_StaticFile implements RokBooster_Compressor_ICache
{
	...
	protected function getOutHeader($type, $datafile_name)
	{
		...
		$use_gzip = ($this->isGzipEnabled() !== false);
		$header = <<< HEADER
...
echo file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . '$datafile_name');
HEADER;
