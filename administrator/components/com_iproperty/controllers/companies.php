...
class IpropertyControllerCompanies extends JControllerAdmin
{
    ...
    public function getModel($name = 'Company', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	public function publish()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->publishCompany($cid, $value)) {
		...
		$this->setRedirect('index.php?option=com_iproperty&view=companies');
	}
    ...
    public function feature()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->featureCompany($cid, $value)) {
    ...
    public function remove()
	{
        ...
        if (empty($cid)) {
			...
			// Remove the items.
			if ($count = $model->deleteCompany($cid)) {
