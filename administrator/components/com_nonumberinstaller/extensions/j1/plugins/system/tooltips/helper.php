...
class plgSystemTooltipsHelper
{
	...
	function onAfterDispatch()
	{
		...
		if ($docType !== 'feed' && !JRequest::getInt('print') && !JRequest::getInt('noscript')) {
			...
			require_once JPATH_PLUGINS . '/system/nnframework/helpers/versions.php';
			$mt_version = NoNumberVersions::getMooToolsVersion($this->params->mootools_compatibility);
			$document->addScript(JURI::root(true) . '/plugins/system/tooltips/js/script' . $mt_version . '.js' . $version);
