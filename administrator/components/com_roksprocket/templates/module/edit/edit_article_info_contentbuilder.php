<?php
/**
 * @version   $Id: edit_article_info_contentbuilder.php 59007 2013-02-01 04:27:51Z steph $
...
<div class="article-info">
	<ul>
		...
		<li>
			...
			<span class="content"><?php echo ($article->title) ? $article->title : 'Not Availble';?></span>
		</li>
		<li>
			<span class="title"><?php rc_e('ROKSPROCKET_ALIAS')?></span>
			<span class="content"><?php echo ($article->alias) ? $article->alias : 'Not Availble';?></span>
		</li>
		<li>
