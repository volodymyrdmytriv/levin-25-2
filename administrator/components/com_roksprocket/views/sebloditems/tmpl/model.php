...
?>
<form
    action="<?php echo JRoute::_('index.php?option=com_roksprocket&view=sebloditems&layout=model&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1');?>"
...
<!--            <select name="filter_type" class="inputbox chzn-done" onchange="this.form.submit()">-->
...
<!--            </select>-->
    ...
    <table class="adminlist">
        ...
        <tr>
            ...
            <th width="15%">
                <?php echo JHtml::_('grid.sort', 'ROKSPROCKET_TYPE', 'st.title', $listDirn, $listOrder); ?>
            </th>
            <th width="5%">
