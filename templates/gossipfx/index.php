...
<head>
    ...
    <?php
        ...
        $gantry->addLess('global.less', 'master.css', 8, array('headerstyle'=>$gantry->get('headerstyle','dark'), 'backgroundstyle'=>$gantry->get('backgroundstyle','style1')));
...
<div class="outercontainer rt-container">
    ...
    <header id="rt-top-surround">
		...
		<?php /** End Top **/ endif; ?>
			...
			<div class="rt-container"><?php /** Begin Header **/ if ($gantry->countModules('header')) : ?>
		<div id="rt-header">
