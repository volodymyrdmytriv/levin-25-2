	...
	<div class="catItemHeader">
	  ...
	  <div class="itemInformation">
	   <ul>
	  	...
	  	<li><?php if($this->item->params->get('catItemDateCreated')): ?>
		<!-- Date created -->
		...
		<li><?php if($this->item->params->get('catItemAuthor')): ?>
		<!-- Item Author -->
		<span class="catItemAuthor">
			<span class="written"><?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?></span> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a>
		</span>
		<?php endif; ?></li>
	   </ul>
	  </div>
