	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
	   ...
	   <ul>
	  	...
	  	<li><?php if($this->item->params->get('itemDateCreated')): ?>
		<!-- Date created -->
		...
		<li><?php if($this->item->params->get('itemAuthor')): ?>
		<!-- Item Author -->
		<span class="itemAuthor">
			<span class="written"><?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp; </span>
		...
		<ul>
			...
			<li>
				<a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
					<img src="<?php echo JURI::root(true); ?>/templates/gossipfx/images/printButton.png" alt="<?php echo JText::_('K2_PRINT'); ?>" />
				</a>
			</li>
			<?php endif; ?>
			...
			<li>
				<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
					<img src="<?php echo JURI::root(true); ?>/templates/gossipfx/images/emailButton.png" alt="<?php echo JText::_('K2_EMAIL'); ?>" />
				</a>
			</li>
			<?php endif; ?>
			...
			<li>
				...
				<?php else: ?>
					...
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
						<img src="<?php echo JURI::root(true); ?>/templates/gossipfx/images/comment.png" alt="<?php echo JText::_('K2_COMMENTS'); ?>" />
					</a>
					<?php else: ?>
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
						<img src="<?php echo JURI::root(true); ?>/templates/gossipfx/images/comment.png" alt="<?php echo JText::_('K2_BE_THE_FIRST_TO_COMMENT'); ?>" />
					</a>
					<?php endif; ?>
				<?php endif; ?>
			</li>
