...
echo '<div class="ip-slider-div">';
    ...
    if( !$this->user->id ){
        ...
        <div align="center">
            ...
            <?php echo JText::_( 'COM_IPROPERTY_LOG_IN_TO_SAVE_SEARCHES' ); ?><br />
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="10">
                            <tr>
                                <td colspan="2"><?php echo JText::_( 'COM_IPROPERTY_SEARCH_TEXT' ); ?></td>
                            </tr>
                            <tr>
                                <td align="right" width="30%" class="form_title"><?php echo JText::_( 'COM_IPROPERTY_TITLE' ); ?>:</td>
                            ...
                            <tr>
                                ...
                                <td width="70%" class="form_input">
                                    <input type="checkbox" class="inputbox" name="email_update" checked="checked" />
                                </td>
                            </tr>
                            <?php endif; ?>
                            <tr>
                                <td>&nbsp;</td>
                                <td class="form_input"><input type="submit" value="<?php echo JText::_( 'COM_IPROPERTY_SAVESEARCH' ); ?>" /></td>
                            </tr>
                            <tr>
                                <td colspan="2">&nbsp;</td>
                            </tr>
