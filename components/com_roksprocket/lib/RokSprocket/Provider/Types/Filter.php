...
class RokSprocket_Provider_Types_Filter extends RokSprocket_Provider_AbstractWordpressPlatformFilter
{
    /**
     *
     */
    protected function setBaseQuery()
    {
        ...
        $this->base_query .= ', CONCAT_WS(",", pm2.meta_id) AS custom_fields';
