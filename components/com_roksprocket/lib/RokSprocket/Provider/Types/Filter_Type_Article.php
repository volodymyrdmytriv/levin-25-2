...
class RokSprocket_Provider_Types_Filter_Type_Article extends RokSprocket_Provider_Filter_Type_AbstractArticle
{
	/**
	 * @var string
	 */
	...
	protected function getInput($name = RokCommon_Filter_Type::JAVASCRIPT_NAME_VARIABLE, $value = '')
	{
        ...
        $link = get_bloginfo('wpurl').'/wp-admin/admin-ajax.php?action=roksprocket_postlist&nonce='.$nonce.'&provider=types&TB_iframe=true&height=425&width=555&modal=false';
