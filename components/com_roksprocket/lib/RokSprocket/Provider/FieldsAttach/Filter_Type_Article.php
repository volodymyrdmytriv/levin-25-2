<?php
/**
 * @version	$Id: Filter_Type_Article.php 54338 2012-07-13 17:49:24Z btowles $
 * @author	 RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2013 RocketTheme, LLC
 * @license	http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */

class RokSprocket_Provider_FieldsAttach_Filter_Type_Article extends RokSprocket_Provider_Filter_Type_AbstractArticle
{
	/**
	 * @var string
	 */
	...
	{
		return rc__('ROKSPROCKET_FILTER_FIELDSATTACH_ARTICLE_RENDER', $this->getTypeDescription($this->getChunkType()));
	}
	...
	public function render($name, $type, $values)
	{
		...
		return rc__('ROKSPROCKET_FILTER_FIELDSATTACH_ARTICLE_RENDER', $this->getInput($name, $value));
	}
	...
	protected function getInput($name = RokCommon_Filter_Type::JAVASCRIPT_NAME_VARIABLE, $value = '')
	{
		...
		$html = array();
		$link = 'index.php?option=com_content&amp;view=articles&amp;layout=modal&amp;tmpl=component&amp;function=jSelectUser_Sprocket';
