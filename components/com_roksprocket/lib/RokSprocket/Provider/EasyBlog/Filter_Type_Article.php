...
class RokSprocket_Provider_EasyBlog_Filter_Type_Article extends RokSprocket_Provider_Filter_Type_AbstractArticle
{
	/**
	 * @var string
	 */
	...
	{
		return rc__('ROKSPROCKET_FILTER_EASYBLOG_ARTICLE_RENDER', $this->getTypeDescription($this->getChunkType()));
	}
	...
	public function render($name, $type, $values)
	{
		...
		return rc__('ROKSPROCKET_FILTER_EASYBLOG_ARTICLE_RENDER', $this->getInput($name, $value));
	}
