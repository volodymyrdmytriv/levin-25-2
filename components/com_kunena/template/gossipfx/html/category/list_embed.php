...
<table class="kblocktable<?php echo $htmlClassBlockTable ?>" id="kcat<?php echo intval($section->id) ?>">
	...
	?>
		...
		<?php endif; ?>
			...
			<td class="kcol-mid kcol-kcattopics visible-desktop1">
			...
			<td class="kcol-mid kcol-kcatreplies visible-desktop1">
			...
			if ($last->exists()) { ?>
			<td class="kcol-mid kcol-kcatlastpost visible-desktop1">
			...
			<?php } else { ?>
			<td class="kcol-mid kcol-knoposts visible-desktop1"><?php echo JText::_('COM_KUNENA_NO_POSTS'); ?></td>
			<?php } ?>
		</tr>
		<?php } } ?>
</table>
