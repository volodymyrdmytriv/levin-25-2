...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
	...
	<td class="kcol-mid kcol-ktopicviews visible-desktop1">
	...
	<td class="kcol-mid kcol-ktopiclastpost visible-desktop1">
