...
$cssurl = JURI::root(true) . '/components/com_kunena/template/gossipfx/css';
?>
<!--[if lte IE 7]>
...
$forumHeader = $template->params->get('forumHeadercolor', $skinner ? '' : '#555555');

if ($forumHeader) {
	$styles .= <<<EOF

	#Kunena div.kblock > div.kheader,#Kunena .kblock div.kheader { background: {$forumHeader} !important; padding: 10px 0; border-bottom: none; }
...
$forumLink = $template->params->get('forumLinkcolor', $skinner ? '' : '#999999');
...
$announcementHeader = $template->params->get('announcementHeadercolor', $skinner ? '' : '#555555');
...
$frontStatsHeader = $template->params->get('frontstatsHeadercolor', $skinner ? '' : '#555555');
...
$onlineHeader = $template->params->get('whoisonlineHeadercolor', $skinner ? '' : '#555555');
...
$inactiveTab = $template->params->get('inactiveTabcolor', $skinner ? '' : '#ffffff');
...
$activeTab = $template->params->get('activeTabcolor', $skinner ? '' : '#ffffff');
...
$hoverTab = $template->params->get('hoverTabcolor', $skinner ? '' : '#ffffff');
...
$topBorder = $template->params->get('topBordercolor', $skinner ? '' : '#e5e5e5');
...
$inactiveFont = $template->params->get('inactiveFontcolor', $skinner ? '' : '#555555');
...
$activeFont = $template->params->get('activeFontcolor', $skinner ? '' : '#555555');
...
$toggleButton = $template->params->get('toggleButtoncolor', $skinner ? '' : '#555555');
